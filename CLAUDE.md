...
- Never add an input the generator reads: no override and no new form control (Kilian, 2026-08-24), and an experience field was declined outright — a factor the profile cannot express is recorded as a known gap, never turned into a question → *The plan generator*
